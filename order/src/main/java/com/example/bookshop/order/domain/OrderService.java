...
import com.example.bookshop.order.event.OrderDispatchedMessage;
...
public class OrderService {
    ...
    private void publishOrderAcceptedEvent(Order order){
        ...
        log.info("Sending order accepted event for id {}", order.id());
        var result = streamBridge.send("acceptOrder-out-0", orderAcceptedMessage);
        log.info("Result of sending message for order id {}: {}", order.id(), result);
    }
