...
public class BookDataLoader {
    ...
    public void loadBookTestData(){
        ...
        var book2 = Book.of("2345678901", "Java for all", "Alice Baker", 12.99, "Paramaount Books");
        var book3 = Book.of("3456789012", "Spring in Action", "Eve Carpenter", 24.99, "Manning Publications");
